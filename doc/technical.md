...
- 游戏：Beat Drop
- 类型：action
- 简述：Pull the crowd — DJ silhouette + flashlight in a dark club. Lead same-color dancers to the matching stage door, dodge bouncers, MIC DROP to stun them. Dual-gate sort, combo multiplier, sweeping techno lights, 128 BPM 4-on-the-floor BGM
...
- 平台元信息：meta.title=Beat Drop；cover_url=/cover.png；category=action；uuid=48962b1d-20d1-4121-8fab-2b807554fd13
...
- `src/BeatDrop/BeatDrop.tsx`：React 组件和交互界面。
- `src/BeatDrop/SplashScene.less`：视觉样式、布局、动画和响应式规则。
- `src/BeatDrop/environment.ts`：游戏源码模块。
- `src/BeatDrop/types.ts`：游戏源码模块。
- `src/BeatDrop/constants.ts`：游戏源码模块。
- `src/BeatDrop/index.ts`：游戏源码模块。
- `src/BeatDrop/BeatDrop.less`：视觉样式、布局、动画和响应式规则。
...
- `src/vite-env.d.ts`
- `src/game-id.ts`
- `src/BeatDrop/BeatDrop.tsx`
- `src/BeatDrop/SplashScene.less`
- `src/BeatDrop/environment.ts`
- `src/BeatDrop/types.ts`
- `src/BeatDrop/constants.ts`
- `src/BeatDrop/index.ts`
- `src/BeatDrop/BeatDrop.less`
- `src/BeatDrop/utils/audio.ts`
- `src/BeatDrop/components/SceneProps.tsx`
- `src/BeatDrop/components/Gate.tsx`
- `src/BeatDrop/components/Dog.tsx`
- `src/BeatDrop/components/Sheep.tsx`
- `src/BeatDrop/components/Wolf.tsx`
- `src/BeatDrop/components/SplashScene.tsx`
- `src/BeatDrop/components/Scene.tsx`
- `src/BeatDrop/hooks/useGameLoop.ts`
- `src/BeatDrop/hooks/useJoystick.ts`
- `src/BeatDrop/i18n/index.ts`
